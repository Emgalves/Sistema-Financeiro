...
def main():
    ...
    cmd = [
        ...
        "--hidden-import=relatorios_interface",
        "--hidden-import=src.relatorios_interface",
        "--hidden-import=relatorio_despesas_aprimorado", 
        "--hidden-import=src.relatorio_despesas_aprimorado",
        "--hidden-import=despesas_rateadas",
        "--hidden-import=src.despesas_rateadas",
        "--hidden-import=gestao_medicoes",
        "--hidden-import=src.gestao_medicoes",
        "--hidden-import=controle_pagamentos_taxas",
        "--hidden-import=src.controle_pagamentos_taxas",
        "--hidden-import=configuracoes_sistema",
        "--hidden-import=src.configuracoes_sistema",
        "--hidden-import=version_control",
