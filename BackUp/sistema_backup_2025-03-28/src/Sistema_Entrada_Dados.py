...
class GestaoContratos:
    ...
    def buscar_dados_bancarios_fornecedor(cnpj_cpf, forma_pagamento):
        """
        Busca os dados bancários do fornecedor incluindo sempre o CNPJ/CPF para TED.
        
        Args:
            cnpj_cpf (str): CNPJ/CPF do fornecedor
            forma_pagamento (str): Forma de pagamento ("PIX" ou "TED")
            
        Returns:
            str: Dados bancários formatados conforme a forma de pagamento
        """
        try:
