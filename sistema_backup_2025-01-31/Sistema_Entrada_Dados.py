...
# type: ignore
from config.utils import ( # type: ignore
    validar_data,
    ...
    formatar_valor_excel, # Valor numérico para o padrão brasileiro
    aplicar_formatacao_celula # Formatação para células de valor no Excel
)
    ...
    def atualizar_dados(self, dados):
        ...
        for lancamento in self.dados_para_incluir:
            valores = (
                ...
                lancamento.get('forma_pagamento', 'PIX'),  # Valor padrão PIX se não existir
...
class EditorLancamento:
    ...
    def preencher_dados(self):
        ...
        self.forma_pagamento.set(self.dados.get('forma_pagamento', 'PIX'))
...
class SistemaEntradaDados:
    def __init__(self, parent=None):
        ...
        # Criar notebook e abas primeiro
